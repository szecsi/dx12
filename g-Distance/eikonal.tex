...
The stencil is the standard $3\times3\times3$ same-sublattice neighborhood
of the target node, minus the center: $26$ neighbors, classified by how
many of the three axes they offset along --
\begin{itemize}
  \item \textbf{face} neighbors ($6$): offset along exactly one axis,
  \item \textbf{edge} neighbors ($12$): offset along exactly two axes,
  \item \textbf{corner/cross} neighbors ($8$): offset along all three
  axes,
\end{itemize}
