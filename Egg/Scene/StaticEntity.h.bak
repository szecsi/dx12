...
namespace Egg { 
	namespace Scene {
		...
		GG_SUBCLASS(StaticEntity, Egg::Scene::Entity)
		...
		protected:
			/// Protected constructor. Initializes the model transformation to indentity.
		...
		public:
			...
			void Rotate(const Egg::Math::Float3& axis, float angle) {
				...
				// quatermion from axis and angle
